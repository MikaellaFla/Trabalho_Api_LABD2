...
public class AgendamentoController {
    ...
    public ResponseEntity<Agendamento> getAgendamentoDetalhes(@PathVariable("IdAgendamento") int IdAgendamento) { // Alterado para int
    ...
    public ResponseEntity<String> updateAgendamentoDetalhes(@PathVariable("IdAgendamento") int IdAgendamento, // Alterado para int
    ...
    public ResponseEntity<String> deleteAgendamentoDetalhes(@PathVariable("IdAgendamento") int IdAgendamento) { // Alterado para int
